...
Note, ```{r}TAC_function``` is based on annual allocations and thus returns BSAI TAC for all species except Alaska Pollock, Greenland turbot, Pacific oeach perch, Sablefish and Other rockfish.  This is because those are the species for which TAC is set on the BS level*.  
