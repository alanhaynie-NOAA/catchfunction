...
ABC.DATA$ABC.BSAI.100 <- ABC.DATA$ABC.BS.100 + ABC.DATA$ABC.AI.100
ABC.DATA$ABC.BSAI.103 <- ABC.DATA$ABC.BS.103 + ABC.DATA$ABC.AI.103
ABC.DATA$ABC.BSAI.104 <- ABC.DATA$ABC.BS.104 + ABC.DATA$ABC.AI.104
ABC.DATA$ABC.BSAI.106 <- ABC.DATA$ABC.BS.106 + ABC.DATA$ABC.AI.106
ABC.DATA$ABC.BSAI.140 <- ABC.DATA$ABC.BS.140 + ABC.DATA$ABC.AI.140
ABC.DATA$ABC.BSAI.141 <- ABC.DATA$ABC.BS.141 + ABC.DATA$ABC.AI.141
ABC.DATA$ABC.BSAI.147 <- ABC.DATA$ABC.BS.147 + ABC.DATA$ABC.AI.147
ABC.DATA$ABC.BSAI.204 <- ABC.DATA$ABC.BS.204 + ABC.DATA$ABC.AI.204
ABC.DATA$ABC.BSAI.303 <- ABC.DATA$ABC.BS.303 + ABC.DATA$ABC.AI.303
ABC.DATA$ABC.BSAI.307 <- ABC.DATA$ABC.BS.307 + ABC.DATA$ABC.AI.307
ABC.DATA$ABC.BSAI.326 <- ABC.DATA$ABC.BS.326 + ABC.DATA$ABC.AI.326
ABC.DATA$ABC.BSAI.400 <- ABC.DATA$ABC.BS.400 + ABC.DATA$ABC.AI.400
ABC.DATA$ABC.BSAI.50 <- ABC.DATA$ABC.BS.50 + ABC.DATA$ABC.AI.50
ABC.DATA$ABC.BSAI.60 <- ABC.DATA$ABC.BS.60 + ABC.DATA$ABC.AI.60
ABC.DATA$ABC.BSAI.65 <- ABC.DATA$ABC.BS.65 + ABC.DATA$ABC.AI.65
ABC.DATA$ABC.BSAI.90 <- ABC.DATA$ABC.BS.90 + ABC.DATA$ABC.AI.90
ABC.DATA$ABC.BSAI.202 <- ABC.DATA$ABC.BS.202 + ABC.DATA$ABC.AI.202
