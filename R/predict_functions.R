...
predict.catch.function <- function(model,fit_sur,fit_nosur,FISH.DATA) {
    ...
    if (NOROCKSOLE) {
        ...
        # Squid
        PREDICTIONS_wSUR$CATCH.BS.50 <- pmin(Pred.SUR.AFA$squid.pred, FISH.DATA$ABC.BSAI.50)
        PREDICTIONS_wSUR$CATCH.AI.50 <- pmin(predict(fit_sur[[39]], FISH.DATA), FISH.DATA$ABC.BSAI.50)
        ...
        # PCod
        PREDICTIONS_wSUR$CATCH.BS.202 <- pmin(Pred.SUR.A80$PCod.pred, FISH.DATA$TAC.BSAI.202)
        PREDICTIONS_wSUR$CATCH.AI.202 <- pmin(predict(fit_sur[[37]], FISH.DATA), FISH.DATA$TAC.BSAI.202)
        # Sablefish
        PREDICTIONS_wSUR$CATCH.BS.203 <- pmin(Pred.SUR.A80$sablefish.pred, FISH.DATA$TAC.BS.203)
        PREDICTIONS_wSUR$CATCH.AI.203 <- pmin(predict(fit_sur[[34]], FISH.DATA), FISH.DATA$TAC.AI.203)
        # Atka
        PREDICTIONS_wSUR$CATCH.BS.204 <- pmin(predict(fit_sur[[30]], FISH.DATA), FISH.DATA$ABC.BSAI.204)
        PREDICTIONS_wSUR$CATCH.AI.204 <- pmin(predict(fit_sur[[31]], FISH.DATA), FISH.DATA$TAC.BSAI.204)
        ...
        PREDICTIONS_wSUR$CATCH.AI.103 <- pmin(predict(fit_sur[[23]], FISH.DATA), FISH.DATA$ABC.BSAI.103)       
        # Rock Sole
        PREDICTIONS_wSUR$CATCH.BS.104 <- pmin(predict(fit_sur[[35]], FISH.DATA), FISH.DATA$ABC.BSAI.104)  
        PREDICTIONS_wSUR$CATCH.AI.104 <- pmin(predict(fit_sur[[36]], FISH.DATA), FISH.DATA$ABC.BSAI.104)     
        # Plaice
        PREDICTIONS_wSUR$CATCH.BS.106 <- pmin(predict(fit_sur[[19]], FISH.DATA), FISH.DATA$ABC.BSAI.106) # No AI
    ...
    if (FLATSUR) {
        ...
        # Squid
        PREDICTIONS_wSUR$CATCH.BS.50 <- pmin(Pred.SUR.AFA$squid.pred, FISH.DATA$ABC.BSAI.50)
        PREDICTIONS_wSUR$CATCH.AI.50 <- pmin(predict(fit_sur[[37]], FISH.DATA), FISH.DATA$ABC.BSAI.50)
        
        
        # Shortraker
        PREDICTIONS_wSUR$CATCH.BS.326 <- pmin(predict(fit_sur[[23]], FISH.DATA), FISH.DATA$ABC.BSAI.326)
        PREDICTIONS_wSUR$CATCH.AI.326 <- pmin(predict(fit_sur[[24]], FISH.DATA), FISH.DATA$ABC.BSAI.326)
        # Rougheye
        PREDICTIONS_wSUR$CATCH.BS.307 <- pmin(predict(fit_sur[[25]], FISH.DATA), FISH.DATA$ABC.BSAI.307)
        PREDICTIONS_wSUR$CATCH.AI.307 <- pmin(predict(fit_sur[[26]], FISH.DATA), FISH.DATA$ABC.BSAI.307)
        # Other Rockfish
        PREDICTIONS_wSUR$CATCH.BS.310 <- pmin(predict(fit_sur[[15]], FISH.DATA), FISH.DATA$ABC.BS.310)
        PREDICTIONS_wSUR$CATCH.AI.310 <- pmin(predict(fit_sur[[16]], FISH.DATA), FISH.DATA$ABC.AI.310)
        # Northern
        ...
        # PCod
        PREDICTIONS_wSUR$CATCH.BS.202 <- pmin(Pred.SUR.A80$PCod.pred, FISH.DATA$TAC.BSAI.202)
        PREDICTIONS_wSUR$CATCH.AI.202 <- pmin(predict(fit_sur[[35]], FISH.DATA), FISH.DATA$TAC.BSAI.202)
        # Sablefish
        PREDICTIONS_wSUR$CATCH.BS.203 <- pmin(Pred.SUR.A80$sablefish.pred, FISH.DATA$TAC.BS.203)
        PREDICTIONS_wSUR$CATCH.AI.203 <- pmin(predict(fit_sur[[33]], FISH.DATA), FISH.DATA$TAC.AI.203)
        # Atka
        PREDICTIONS_wSUR$CATCH.BS.204 <- pmin(predict(fit_sur[[28]], FISH.DATA), FISH.DATA$ABC.BSAI.204)
        PREDICTIONS_wSUR$CATCH.AI.204 <- pmin(predict(fit_sur[[29]], FISH.DATA), FISH.DATA$TAC.BSAI.204)
        
        # Yellowfin
        PREDICTIONS_wSUR$CATCH.BS.140 <- pmin(Pred.SUR.A80$yellowfin.pred, FISH.DATA$TAC.BSAI.140) # No AI
        # Arrowtooth
        PREDICTIONS_wSUR$CATCH.BS.141 <- pmin(Pred.SUR.flat$arrowtooth.pred, FISH.DATA$TAC.BSAI.141)
        PREDICTIONS_wSUR$CATCH.AI.141 <- pmin(predict(fit_sur[[27]], FISH.DATA), FISH.DATA$ABC.BSAI.141)
        # Kamchatka
        PREDICTIONS_wSUR$CATCH.BS.147 <- pmin(predict(fit_sur[[9]], FISH.DATA), FISH.DATA$ABC.BSAI.147)
        PREDICTIONS_wSUR$CATCH.AI.147 <- pmin(predict(fit_sur[[10]], FISH.DATA), FISH.DATA$ABC.BSAI.147)
        
        # Other Flatfish
        PREDICTIONS_wSUR$CATCH.BS.100 <- pmin(Pred.SUR.flat$Oflat.pred, FISH.DATA$TAC.BSAI.100)
        PREDICTIONS_wSUR$CATCH.AI.100 <- pmin(predict(fit_sur[[20]], FISH.DATA), FISH.DATA$ABC.BSAI.100)
        # Greenland turbot
        PREDICTIONS_wSUR$CATCH.BS.102 <- pmin(predict(fit_sur[[17]], FISH.DATA), FISH.DATA$ABC.BS.102)
        PREDICTIONS_wSUR$CATCH.AI.102 <- pmin(predict(fit_sur[[18]], FISH.DATA), FISH.DATA$ABC.AI.102)
        # Flathead sole,
        PREDICTIONS_wSUR$CATCH.BS.103 <- pmin(predict(fit_sur[[21]], FISH.DATA), FISH.DATA$ABC.BSAI.103)   
        PREDICTIONS_wSUR$CATCH.AI.103 <- pmin(predict(fit_sur[[22]], FISH.DATA), FISH.DATA$ABC.BSAI.103)       
        # Rock Sole
        PREDICTIONS_wSUR$CATCH.BS.104 <- pmin(Pred.SUR.flat$rocksole.pred, FISH.DATA$TAC.BSAI.104) 
        PREDICTIONS_wSUR$CATCH.AI.104 <- pmin(predict(fit_sur[[34]], FISH.DATA), FISH.DATA$ABC.BSAI.104)     
        # Plaice
        PREDICTIONS_wSUR$CATCH.BS.106 <- pmin(predict(fit_sur[[19]], FISH.DATA), FISH.DATA$ABC.BSAI.106) # No AI
